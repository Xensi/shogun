...
game_state.boot.prototype = {
    ...
    preload: function() {
        ...
        game.load.spritesheet('button', 'assets/upgrade.png', 32, 9);
...
game_state.main.prototype = {
    ...
    create: function() {
        ...
        this.enter = game.input.keyboard.addKey(Phaser.Keyboard.ENTER);
        this.enter.onDown.addOnce(this.endLevel, this);
        //"explosions"
        ...
        this.scoreText = game.add.text(16, 16, 'Score: ' + score, { font: "16px courier", fill: "#FFFFFF" });
        scoreAtStart = score;
        ...
        this.timeText = game.add.text(16, 16, 'Time: 0', { font: "16px courier", fill: "#FFFFFF" });
...
game_state.RPG.prototype = {
    ...
    create: function() {
        ...
        var style2 = { font: "16px courier", fill: "#FFFFFF" };
        this.titleText = game.add.text(500, 64, 'LEVEL UP', style);
        this.titleText.anchor.set(0.5);
        this.titleText.align = 'center';
        this.rpgText = game.add.text(500, 120, "Use your accumulated points to upgrade!\n(Press enter when finished)", style2);
        this.rpgText.anchor.set(0.5);
        this.rpgText.align = 'center';
        this.expText = game.add.text(150, 100, 'Score: ' + score, style2);
        this.expText.anchor.set(0.5);

        this.button = game.add.button(150, 260, 'button', this.levelUp, this, 1, 0, 2, 1);
        this.level.add(this.button);
        
        this.level.setAll('scale.x', 4);
        this.level.setAll('scale.y', 4);
        this.swordText = game.add.text(150, 200, "SPIRIT BLADE: 40\nSpacebar to fire\n Boomerang blade destroys all\nCatch it; throw again.", style2);
        this.level.add(this.swordText);
        
        this.level.setAll('anchor.x', 0.5);
        this.level.setAll('anchor.y', 0.5);
    ...
    levelUp: function() {
        if (score >= 40 && canThrowSword == false){
            canThrowSword = true;
            score -= 40;
            this.expText.text = 'Score: ' + score;
        }
    },
